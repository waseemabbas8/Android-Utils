...
import com.peopleperfectae.model.RequestState
import com.peopleperfectae.ui.GenericRecyclerViewAdapter
import com.peopleperfectae.ui.OnListItemClickListener

const val VIEW_TYPE_PLACEHOLDER = 6982
const val VIEW_TYPE_DATA_ITEM = 6977

abstract class PaginationListAdapter<T>(private val itemLayout: Int, private val placeholderLayout: Int, diffCallback: DiffUtil.ItemCallback<T>) :
